...
class TripoConvertModelRequest(BaseModel):
    ...
    quad: Optional[bool] = Field(
        False, description="Whether to apply quad to the model"
    )
    force_symmetry: Optional[bool] = Field(
        False, description="Whether to force symmetry"
    )
    face_limit: Optional[int] = Field(
        10000, description="The number of faces to limit the conversion to"
    )
    flatten_bottom: Optional[bool] = Field(
        False, description="Whether to flatten the bottom of the model"
    )
    flatten_bottom_threshold: Optional[float] = Field(
        0.01, description="The threshold for flattening the bottom"
    )
    ...
    pivot_to_center_bottom: Optional[bool] = Field(
        False, description="Whether to pivot to the center bottom"
    )
